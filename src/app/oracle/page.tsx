...
export default function OraclePage() {
  ...
  return (
    <div className="animate-page-enter max-w-7xl mx-auto w-full h-[calc(100vh-136px-env(safe-area-inset-bottom))] md:h-auto min-h-0 flex flex-col pb-0 md:pb-12 px-0 sm:px-4">
